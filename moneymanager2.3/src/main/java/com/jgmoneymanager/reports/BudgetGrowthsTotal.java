 ...
 */
public class BudgetGrowthsTotal extends MyAbstractDemoChartctivity {
    ...
    public boolean onMenuOpened(int featureId, Menu menu) {
        if (menuOut) {
            BudgetGrowthsTotal.menu.setVisibility(View.INVISIBLE);
            scrollView.smoothScrollTo(BudgetGrowthsTotal.menu.getMeasuredWidth(), 0);
            menuOut = false;
        }
        else {
            BudgetGrowthsTotal.menu.setVisibility(View.VISIBLE);
            scrollView.smoothScrollTo(0, 0);
            menuOut = true;
        }
