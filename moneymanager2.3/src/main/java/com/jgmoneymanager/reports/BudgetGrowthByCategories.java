 ...
 */
public class BudgetGrowthByCategories extends MyAbstractDemoChartctivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.tvATTitle)).setText(R.string.repBudgetGrowth);
    }
            ...
            for (int i = 0; i < categoriesList.size(); i++) {
                ...
                if (category.isSelected()) {
                    ...
                    String query = "select " + colCategory + ", " + BudgetTableMetaData.FROM_DATE + ", " +
                            ...
                            " order by 2";
                    Cursor cursor = DBTools.createCursor(BudgetGrowthByCategories.this, query);
                        ...
                        final Command cmdPeriod = new Command() {
                            ...
                            public void execute() {
                                ...
                                if (periodStart.compareTo(periodEnd) < 0) {
                                    ...
                                    DialogTools.toastDialog(BudgetGrowthByCategories.this, R.string.msgFromDateIsLessThanTo, Toast.LENGTH_LONG);
                            }
                        };
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK)
            if (requestCode == Constants.RequestCategoryForReport) {
                refreshList(categoriesList, periodStart, periodEnd);
                Tools.setPreference(BudgetGrowthByCategories.this, R.string.budgetGrowthCategIDsKey, Tools.convertListToString(categoriesList), false);
            }
    }
    ...
    public boolean onMenuOpened(int featureId, Menu menu) {
        if (menuOut) {
            BudgetGrowthByCategories.menu.setVisibility(View.INVISIBLE);
            scrollView.smoothScrollTo(BudgetGrowthByCategories.menu.getMeasuredWidth(), 0);
            menuOut = false;
        }
        else {
            BudgetGrowthByCategories.menu.setVisibility(View.VISIBLE);
            scrollView.smoothScrollTo(0, 0);
            menuOut = true;
        }
