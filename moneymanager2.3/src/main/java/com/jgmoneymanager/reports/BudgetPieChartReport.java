...
public class BudgetPieChartReport extends MyAbstractDemoChartctivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.piechartreport);
        ((TextView) findViewById(R.id.tvATTitle)).setText(R.string.repBudgetPieChart);
    ...
    void recreateDateInterval(int addPeriod) {
        ...
        switch (addPeriod) {
            case 0:
                startDate = Tools.truncDate(ReportSrv.getCurrentDate(currentDateInterval), Constants.DateTruncTypes.dateTruncMonth);
                break;
            case 1:
