 ...
 */
public class BudgetedAmountTotal extends MyAbstractDemoChartctivity {
    ...
    public boolean onMenuOpened(int featureId, Menu menu) {
        if (menuOut) {
            BudgetedAmountTotal.menu.setVisibility(View.INVISIBLE);
            scrollView.smoothScrollTo(BudgetedAmountTotal.menu.getMeasuredWidth(), 0);
            menuOut = false;
        }
        else {
            BudgetedAmountTotal.menu.setVisibility(View.VISIBLE);
            scrollView.smoothScrollTo(0, 0);
            menuOut = true;
        }
