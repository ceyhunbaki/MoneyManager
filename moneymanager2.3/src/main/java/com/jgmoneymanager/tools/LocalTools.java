...
public class LocalTools {
	...
	public static void startupActions(Context context) {
		...
		// DialogTools.systemNotification(context, TransferList.class, 1,
		// context.getString(R.string.app_name),
		// context.getString(R.string.rptransactions), "text",
    ...
    public static Button addButtonToMenuList(Context context, int titleID, String buttonTag) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        Button button = (Button)inflater.inflate(R.layout.menu_button_tmp, null);
        button.setText(titleID);

        View rootView = ((Activity)context).getWindow().getDecorView().findViewById(android.R.id.content);

        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layoutParams.setMargins(0, 0, 0, Math.round(context.getResources().getDimension(R.dimen.main_round_button_side) / context.getResources().getDisplayMetrics().density));

        LinearLayout layout = (LinearLayout)rootView.findViewById(R.id.hmLayOpen);
    ...
    public static void fillSpinner(Spinner spinner, Context context, Cursor cursor, String columnName) {
        ...
        SimpleCursorAdapter mAdapter = new SimpleCursorAdapter(context, R.layout.simple_spinner_item_blue, cursor, from, to);
