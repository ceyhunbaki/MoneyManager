...
public class CurrRatesList extends MyActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.currency_rates_list);
			...
			case R.id.btCurrRatesFilter:
				...
				final Command cmdPeriod = new Command() {
					...
					public void execute() {
						...
						periodEnd = Tools.lastDay(new Date(spinnerYearTo.getSelectedItemPosition() + minYear - 1900, spinnerMonthTo.getSelectedItemPosition(), 1));
