 ...
 */
public class BudgetedAmountByCategories extends AbstractDemoChart {
    ...
    private void setPeriods() {
        ...
        if (currentDateInterval == Constants.ReportTimeIntervalBudget.ThisYear.index()) {
            periodStart = Tools.truncDate(BudgetedAmountByCategories.this, Tools.getCurrentDate(), Constants.DateTruncTypes.dateTruncYear);
            periodEnd = Tools.truncDate(BudgetedAmountByCategories.this, Tools.getCurrentDate(), Constants.DateTruncTypes.dateTruncMonth);
            ...
            periodStart = Tools.truncDate(BudgetedAmountByCategories.this, Tools.AddMonth(Tools.getCurrentDate(), -12), Constants.DateTruncTypes.dateTruncMonth);
            periodEnd = Tools.truncDate(BudgetedAmountByCategories.this, Tools.getCurrentDate(), Constants.DateTruncTypes.dateTruncMonth);
