...
public class Constants {
    ...
    public static void rebuildConstants() {
        ...
        DECIMAL_POINT = com.jgmoneymanager.tools.Constants.decimalSeparatorSymbol;//DECIMAL_FORMAT.getDecimalSeparator();
        DECIMAL_SEPARATOR = com.jgmoneymanager.tools.Constants.digitGropingSymbol;//DECIMAL_FORMAT.getGroupingSeparator();
